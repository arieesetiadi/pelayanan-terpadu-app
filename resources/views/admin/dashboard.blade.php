            ...
            <div class="col-6 d-flex justify-content-end mt-2">
                    ...
                    <div class="modal fade"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form id="filterDateWilayahForm"
                                      action="/admin/request-ttd-kanit"
                                      method="POST"
                ...
                <div>
                    <button id="filterDateWilayah"
                            class="btn"
                            data-bs-toggle="modal"
                            data-bs-target="#laporanWilayahModalPDF"
                            title="Download PDF per Wilayah">
                    ...
                    <div class="modal fade"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form target="_blank"
                                      id="filterDateWilayahForm"
                                      action="/admin/laporan-wilayah/pdf"
                                      method="POST">
                                    <div class="modal-header">
                                        <h5 class="modal-title"
                                            id="exampleModalLabel">Periode Laporan</h5>
                                        <button type="button"
                                                class="btn-close"
                                                data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                ...
                <div>
                    <button id="filterDateWilayah"
                            class="btn"
                            data-bs-toggle="modal"
                            data-bs-target="#laporanWilayahModalExcel"
                            title="Download Excel per Wilayah">
                        <i class="fa-solid fa-file-excel fa-2x text-success"></i>
                    </button>

                    <!-- Modal -->
                    <div class="modal fade"
                         id="laporanWilayahModalExcel"
                         tabindex="-1"
                         aria-labelledby="exampleModalLabel"
                         aria-hidden="true"
                         data-bs-backdrop="static">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form target="_blank"
                                      id="filterDateWilayahForm"
                                      action="/admin/laporan-wilayah/excel"
                                      method="POST">
                                    <div class="modal-header">
                                        <h5 class="modal-title"
                                            id="exampleModalLabel">Periode Laporan</h5>
                                    ...
                                    @forelse ($laporanSKTLK as $i => $sktlk)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{-- Tombol hapus --}}
                                                <a href="/admin/sktlk/hapus/{{ $sktlk->id }}"
                                                   title="Hapus"
                                                ...
                                                <div class="modal fade"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="exampleModalLabel">Upload File
                                                                </h5>
                                                                <button type="button"
                                                                        class="btn-close"
                                                                        data-bs-dismiss="modal"
                                                            ...
                                                            <form action="/admin/sktlk/upload-file"
                                                                  method="POST"
                                                                  enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    @csrf
                                                ...
                                                <div class="modal fade"
                                                     id="detail-modal-sktlk-{{ $sktlk->id }}"
                                                     tabindex="-1"
                                                     aria-labelledby="exampleModalLabel"
                                                     aria-hidden="true">
                                                    <div class="modal-dialog">
