        ...
        <div class="row justify-content-between">
            ...
            <div class="col-4 d-flex justify-content-end">
                ...
                <form id="filterDateForm"
                      action="/admin/sktlk/filter-date"
                      method="POST">
                    @csrf
            ...
            <tbody>
                @foreach ($laporanSKTLK as $i => $sktlk)
                    <tr>
                        ...
                        <td>{{ $sktlk->alamat }}</td>
                        <td>{{ dateTimeFormat($sktlk->tanggal_kejadian) }}</td>
                        ...
                        <td style="width: 100px"
                            class="{{ auth()->user()->jenis_pengguna != 'AdminSPKT' ? 'd-none' : 'd-flex' }}">
                            {{-- Tombol download --}}
                            @if ($sktlk->dokumen_persetujuan != null)
                                <a href="{{ asset('assets-user/upload/') . '/' . $sktlk->dokumen_persetujuan }}"
                                   target="_blank"
                        ...
                        <div class="modal fade"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title"
                                            id="exampleModalLabel">Detail Dokumen</h5>
                                        <button type="button"
                                                class="btn-close"
                                                data-bs-dismiss="modal"
                                                aria-label="Close"></button>
