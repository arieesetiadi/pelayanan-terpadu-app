        ...
        <div class="container p-5 styled-bg">
            ...
            <center>
                <div class="flat-appointment btn-linear hv-linear-gradient">
                    <a href="/form/lapor-sktlk" class="font-style linear-color border-corner">Lapor</a>
                </div>
            </center>
                    ...
                    <div class="col-12">
                        ...
                        <ol>
                            <li><strong>Surat Sertifikat Tanah:</strong>
                                <ul>
                                    <li>Menunjukan bukti 2x (dua kali) penerbitan pada surat kabar / koran atas
                                        Sertifikat
                                        Hak Milik (SHM) yang hilang.</li>
                                    <li>Rekomendasi yang membenarkan dari Kantor Badan Pertanahan Nasional (BPN),
                                        termasuk
                                        data-data keterangan lengkap berdasarkan Sertifikat Hak Milik (SHM) yang hilang
                                        dan
                                        tidak sedang dalam permasalahan.</li>
                                    <li>Membuat surat pernyataan dari pemilik bahwa Sertifikat Hak Milik (SHM) telah
                                        hilang.
                                    </li>
                        ...
                        <ol>
                            <li><strong>Buku Pemilik Kendaraan Bermotor (BPKB) :</strong>
                                <ul>
                                    <li>Menunjukan bukti 2x (dua kali) penerbitan pada surat kabar / koran atas Buku
                                        Pemilik
                                        Kendaraan Bermotor (BPKB) yang hilang.</li>
                                    <li>Menunjukan Surat Tanda Nomor Kendaraan (STNK) asli dan bukti cek fisik
                                        kendaraan.
                                    </li>
                                    <li>Membuat surat pernyataan dari pemilik bahwa Buku Pemilik Kendaraan Bermotor
                                        (BPKB)
                                        telah hilang.</li>
                                    <li>Foto copy identitas pelapor / yang membuat laporan kehilangan.</li>
                                </ul>
                        ...
                        <ol>
                            <li><strong>Surat Tanda Nomor Kendaraan (STNK) :</strong>
                                <ul>
                                    <li>Menunjukan bukti surat kabar / koran atas Surat Tanda Nomor Kendaraan (STNK)
                                        yang
                                        hilang.</li>
                                    <li>Menunjukan Buku Pemilik Kendaraan Bermotor (BPKB) asli / apabila masih dalam
                                        proses
                                        kredit, minta Rekomendasi dari Dealer dan tidak sedang dalam permasalahan.</li>
                                    <li>Membuat surat pernyataan dari pemilik bahwa Surat Tanda Nomor Kendaraan (STNK).
                                    </li>
                                    <li>Foto copy identitas pelapor / yang membuat laporan kehilangan.</li>
                                </ul>
                            </li>
                        ...
                        <ol>
                            <li><strong>PASPOR :</strong>
                                <ul>
                                    <li>Menunjukan bukti 2x (dua kali) penerbitan pada surat kabar / koran atas PASPOR
                                        yang
                                        hilang.</li>
                            ...
                            <li><strong>Surat Ijin Mengemudi (SIM) :</strong>
                                <ul>
                                    <li>Rekomendasi yang membenarkan dari Sat.Lantas tempat Surat Ijin Mengemudi (SIM)
                                        dikeluarkan, termasuk data-data keterangan lengkap berdasarkan Surat Ijin
                                        Mengemudi
                                        (SIM) yang hilang.</li>
                                    <li>Foto copy identitas pelapor / yang membuat laporan kehilangan.</li>
                                </ul>
                        ...
                        <ol>
                            <li><strong>Kartu BPJS (Badan Penyelenggara Jaminan Sosial):</strong>
                                <ul>
                                    <li>Rekomendasi yang membenarkan dari Kantor BPJS yang bersangkutan, termasuk
                                        data-data
                            ...
                            <li><strong>Surat-surat penting lainnya :</strong>
                                <ul>
                                    <li>Rekomendasi yang membenarkan dari Kantor atau Dinas instansi yang mengeluarkan /
                                        menerbitkan, termasuk data-data keterangan lengkap berdasarkan surat / dokumen
                                        yang
                                        hilang dan tidak sedang dalam permasalahan.</li>
                                    <li>Foto copy identitas pelapor / yang membuat laporan kehilangan.</li>
                                </ul>
