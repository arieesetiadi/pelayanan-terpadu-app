            ...
            <div class="row py-5"
                ...
                <div class="col-6">
                    <div class="card shadow-lg">
                        <img class="card-img-top"
                             width="100%"
                             src="{{ asset('assets-user/img/rev-slider/slider-3.jpg') }}"
                             alt="Pengaduan Masyarakat">
                        <div class="card-body">
                            <h5 class="d-inline-block h6"
                                style="color: black">Pengaduan Masyarakat</h5>
                            ...
                            <div class="d-inline-block dropdown">
                                ...
                                <div class="dropdown-menu"
                                    ...
                                    <a class="dropdown-item"
                                       href="/pengaduan-masyarakat/sktlk">SKTLK (Surat Keterangan
                                        Tanda Lapor
                                        Kehilangan)</a>
                                    <a class="dropdown-item"
                                       href="/pengaduan-masyarakat/sik">Surat Izin Keramaian</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-6">
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body">
                            <h5 class="d-inline-block h6"
                                style="color: black">Penindaklanjutan Tindak Kriminal</h5>
                            ...
                            <div class="d-inline-block dropdown">
                                ...
                                <div class="dropdown-menu"
                                     aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item"
                                       href="/tindak-kriminal/sp2hp">SP2HP</a>
                                </div>
                            </div>
                        </div>
                    </div>
