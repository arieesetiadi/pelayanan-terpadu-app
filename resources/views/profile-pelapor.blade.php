            ...
            <div class="row mt-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body"
                            ...
                            <center>
                                ...
                                <h6>{{ session('pelapor')->NAMA_LENGKAP }}</h6>
                                <span class="d-block">{{ session('pelapor')->EMAIL_PELAPOR }}</span>
                                <span class="d-block">{{ session('pelapor')->TELEPON_PELAPOR }}</span>

                                <hr>

                                <span>{{ session('pelapor')->ALAMAT_PELAPOR }}</span>
                            </center>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="card">
                        ...
                        <div class="card-body"
                             style="height: 500px">
                            <form action="/profile/pelapor/update"
                                  method="POST">
                                @csrf
                                <input type="hidden"
                                       name="id"
