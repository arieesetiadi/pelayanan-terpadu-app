...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login Pelapor | SPKT Polres Badung</title>
    <meta name="viewport"
          content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Dashboard Template"
          name="description" />
    <meta content="Themesdesign"
          name="author" />
    ...
    <link href="{{ asset('assets-admin/css/bootstrap.min.css') }}"
          ...
          type="text/css" />
    <!-- Icons Css -->
    <link href="{{ asset('assets-admin/css/icons.min.css') }}"
          rel="stylesheet"
          type="text/css" />
    <!-- App Css-->
    <link href="{{ asset('assets-admin/css/app.min.css') }}"
          id="app-style"
          rel="stylesheet"
          type="text/css" />
...
<body class="auth-body-bg"
      style="background-color: rgb(16,36,60)">
    <div>
                                ...
                                <div class="col-lg-9">
                                    <div>
                                        <div class="text-center">
                                            ...
                                            <h4 class="font-size-18 mt-4">Login Pelapor</h4>
                                        </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p>Belum memiliki akun ? <a href="/daftar"
